    ...
    def runApp(self, BASE_URL, SITE_NAME):
        ...
        for categ_url in categ_urls:
            ...
            for topic_link in categ_topic_links:
                categ_topic_urls.append('https://forum.tudiabetes.org' + topic_link['href'])
...
if __name__ == '__main__':
    ...
    webdriverPath = '/Users/yasaminabbaszadegan/Desktop/STEMAWAY/Module2_test/Pycharm_sara/geck/geckodriver'

    # Forum to scrape URL
    BASE_URL = 'https://forum.tudiabetes.org/categories'

    # Name of the forum
    SITE_NAME = 'tudiabetes'
